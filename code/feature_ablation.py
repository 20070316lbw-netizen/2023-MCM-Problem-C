...
def run_feature_ablation():
    ...
    combos = {
        ...
        "hard+freq+overlap+repeat": best_combo,
        "全特征含overlap": all_features,
        "加入freq_x_unique": best_combo + ["freq_x_unique"],
        "加入letter_score": best_combo + ["total_letter_score"],
        "两个都加": best_combo + ["freq_x_unique", "total_letter_score"],
    }
